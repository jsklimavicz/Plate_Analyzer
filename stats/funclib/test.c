  ...
  for (i = 0; i < d->n; ++i)
    {
      ...
      if (i == 1){printf("a=%f, b=%f, c=%f, x=%f, y=%f, yi=%f\n", a, b, c, ti, y, yi);}
  ...
  for (i = 0; i < d->n; ++i)
    {
      ...
      double Da = -ei;
      double Db = -(a / c) * ei * zi;
      double Dc = -(a / c) * ei * zi * zi;

      gsl_matrix_set(J, i, 0, Da);
      gsl_matrix_set(J, i, 1, Db);
      gsl_matrix_set(J, i, 2, Dc);
      if (i == 1){printf("Jacobian: a=%f, b=%f, c=%f, x=%f, Da=%f, Db=%f, Dc=%f\n", a, b, c, ti, Da, Db, Dc);}
    }
  ...
  for (i = 0; i < d->n; ++i)
    {
      ...
      if (i == 1){printf("DerDev: a=%f, b=%f, c=%f, x=%f \n", a, b, c, ti);}
      if (i == 1){printf("\tva=%f, vb=%f, vc=%f\n", va, vb, vc);}
      if (i == 1){printf("\tDab=%f, Dac=%f, Dbb=%f, Dbc=%f, Dcc=%f\n", Dab, Dac, Dbb, Dbc, Dcc);}
