		 ...
		 const struct multimin_params oparams)
{
	...
	const gsl_multimin_fdfminimizer_type *Tfdf =  malloc(sizeof(gsl_multimin_fdfminimizer_type));
	const gsl_multimin_fminimizer_type *Tf =  malloc(sizeof(gsl_multimin_fminimizer_type));
	const char *Tname;
